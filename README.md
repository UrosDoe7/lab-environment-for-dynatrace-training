...
For the beta version which can deply full environmnt Easytravel with OneAgent installation + Monaco for configuration go [here](https://github.com/JLLormeau/lab_beta)
